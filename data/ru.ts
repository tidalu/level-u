    ...
    classList: [
      {
        ...
        list: [
          ...
          },
          {
            ...
            description:
              'Наши комплексные курсы подготовки по языку разработаны для того, чтобы обеспечить учащихся навыками и стратегиями, необходимыми для успешной сдачи экзаменов IELTS, CEFR и TOEFL. Каждый курс направлен на развитие всех основных языковых навыков: чтение, письмо, аудирование и говорение, с учетом специфики каждого формата экзамена.',
            video:
              'https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0',
            forWhom: [
              'Студенты, стремящиеся учиться за границей или эмигрировать в англоязычные страны.',
              'Лица, которым нужен высокий балл на IELTS, CEFR или TOEFL для академических или профессиональных целей.',
              'Учащиеся, ищущие комплексную подготовку и практику, ориентированную на экзамены IELTS, CEFR или TOEFL.',
              'Лица, стремящиеся оценить или улучшить свои знания английского языка в соответствии с международными стандартами.',
            ],
            cost: '$ N/A',
            duration:
              '8 недель (IELTS и TOEFL), в зависимости от желаемого уровня владения (CEFR)',
            intensity: '4 / 4 (IELTS и TOEFL), 3 / 4 (CEFR)',
            purpose:
              'Обеспечить учащихся целенаправленной подготовкой к экзаменам IELTS, CEFR и TOEFL, гарантируя, что они хорошо подготовлены для достижения своих желаемых результатов или уровней владения языком.',
            effects: [
              ...
              'Увеличение уверенности в использовании языка и стратегиях сдачи экзаменов в различных форматах.',
            ],
          },
          {
            name: 'Интенсивный курс',
            description:
              'Этот интенсивный курс предназначен для быстрого погружения в изучение языка для тех, кто хочет быстро улучшить свои английские навыки. Курс охватывает все аспекты изучения языка, включая чтение, письмо, аудирование и говорение, с акцентом на быстрое продвижение и практическое применение.',
            video:
              'https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0',
            forWhom: [
              'Лица, стремящиеся к быстрому улучшению своих навыков английского языка.',
              'Студенты, готовящиеся к предстоящим экзаменам или профессиональным вызовам, требующим высокого уровня языковой подготовки.',
              'Ученики, предпочитающие сжатый, интенсивный формат для ускоренного развития языка.',
            ],
            cost: '$ N/A',
            duration: '4 недели',
            intensity: 5 / 4,
            purpose:
              'Предоставить ускоренное обучение языку, которое позволяет учащимся добиться значительного прогресса за короткий период времени.',
            effects: [
              'Значительное улучшение навыков английского языка за сжатые сроки.',
              'Улучшение способности эффективно использовать английский язык в академических или профессиональных условиях.',
              'Повышение уверенности и компетенции во всех областях использования языка.',
            ],
          },
        ],
      },
