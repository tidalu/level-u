export const data = {
  about: {
    ...
    whyChooseUsDesc:
      "Bizning ta'limga yondashuvimizni noyob va samarali qiladigan jihatlarni kashf eting",
    reasonCards: {
      whyAnswer:
        "Bizning ta'limga yondashuvimizni noyob va samarali qiladigan jihatlarni kashf eting",
      expertinstr: "Tajribali O'qituvchilar",
      expertinstrDesc:
        "Bizning jamoamiz tajribali va sertifikatlangan o'qituvchilardan iborat bo'lib, sizning akademik maqsadlaringizga erishishingizga yordam berishga bag'ishlangan.",
      modernCurriculum: "Zamonaviy O'quv Dasturi",
      modernCurriculumDesc:
        "Bizning o'quv dasturimiz sizni bugungi raqobatbardosh dunyoda muvaffaqiyatga erishish uchun zarur bo'lgan so'nggi bilim va ko'nikmalar bilan ta'minlash uchun ishlab chiqilgan.",
      personalizedLearning: "Shaxsiylashtirilgan O'rganish",
      personalizedLearningDesc:
        "Biz sizning to'liq salohiyatingizga erishishingiz va akademik maqsadlaringizga yetishingizga yordam berish uchun shaxsiylashtirilgan ta’lim tajribalarini taklif qilamiz.",
      globalPerspective: "Global Nuqtai Nazar",
      globalPerspectiveDesc:
        "Bizning dasturlarimiz sizga global nuqtai nazarni taqdim etish va o'zaro bog'langan dunyoda muvaffaqiyatga tayyorlash uchun ishlab chiqilgan.",
      community: "Jamoa",
      communityDesc:
        "Bizning jonli ta'lim oluvchilar va o'qituvchilar jamoamizga qo'shiling va mazmunli muhokamalar va hamkorliklarga kirishing.",
      careerSupport: "Kasbiy Qo'llab-quvvatlash",
      careerSupportDesc:
        "Biz sizning kasbiy maqsadlaringizga erishishingiz va tanlangan sohangizda muvaffaqiyat qozonishingiz uchun kasbiy yo'l-yo'riq va qo'llab-quvvatlash xizmatlarini taqdim etamiz.",
    },
    testimonials: "Talabalarimiz Nima Deyishadi",
    testimonialsSubtitle:
      "Bizning ta'lim oluvchilar jamoamiz fikrlarini tinglang",
  },
  ...
  header: {
    ...
    accessibility: {
      ...
      reduceText: "Matnni kichiklashtirish",
      grayscale: "Oq-qora",
...
`,
  ...
  classPage: {
        ...
        list: [
          {
            ...
            description:
              "Ushbu keng qamrovli kurs ingliz tilining asosiy ko‘nikmalarini, jumladan, o‘qish, yozish, tinglash va gapirishni qamrab oluvchi mustahkam poydevorni taqdim etadi. Kurs amaliy foydalanish va muloqotga urg‘u beradi, kundalik va professional aloqalar uchun mustahkam asos yaratadi.",
            video:
              "https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0",
            forWhom: [
              "Umumiy ingliz tili darajasini oshirishni istagan shaxslar.",
              "Turli kontekstlarda ingliz tilidan foydalanishda ishonch hosil qilishni xohlaydigan boshlang‘ich darajadagi o‘rganuvchilar.",
              "Shaxsiy yoki professional maqsadlar uchun muloqot ko‘nikmalarini rivojlantirishga muhtoj bo‘lgan notug‘ri ingliz tilida so‘zlashuvchilar.",
            ],
            cost: "500.000 so‘m",
            duration: "18 oy",
            intensity: 3 / 5,
            ...
            effects: [
              "Ingliz tilida erkin gapirish qobiliyatining oshishi.",
              "Og‘zaki va yozma ingliz tilini tushunish va yaratish qobiliyatining oshishi.",
              "Kundalik aloqalarda ingliz tilidan foydalanishdagi ishonchning oshishi.",
            ],
            lengthOfClasses: "1 soat 30 daqiqa",
          ...
          },
          {
            ...
            description:
              "Ushbu shaxsiy darslar sizning aniq ehtiyojlaringiz va o‘quv maqsadlaringizga mos ravishda tuzilgan. Siz biznes ingliz tili, akademik yozish yoki muloqot ko‘nikmalariga e’tibor qaratishingiz kerak bo‘lsa, bu bir-biriga o‘xshash darslar maqsadli yo‘riqnomalar va fikr-mulohazalarni taqdim etadi.",
            video:
              "https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0",
            forWhom: [
              "Ularning o‘ziga xos ehtiyojlari va maqsadlariga asoslangan moslashtirilgan yo‘riqnomalarni izlayotgan o‘rganuvchilar.",
              "Ishda tegishli ingliz tilini rivojlantirishga muhtoj bo‘lgan mutaxassislar.",
              "O‘qish yoki imtihonlarida muvaffaqiyat qozonish uchun diqqatni jamlashni talab qiluvchi talabalar.",
            ],
            cost: "2.500.000 so‘m",
            duration: "9 oy",
            intensity: 5 / 5,
            ...
            effects: [
              "Shaxsiy ehtiyojlarga moslashtirilgan fikr-mulohazalar va darslar.",
              "Ingliz tilining maqsadli sohalarida tez o‘sish.",
              "Ingliz tilidan foydalanish bo‘yicha ko‘nikmalar va ishonchning oshishi.",
            ],
          ...
          },
          {
            ...
            description:
              "Juda yosh bolalar uchun, English for Kids kurslari tilni qiziqarli va jalb etuvchi tarzda tanishtiradi. Ushbu bosqichda, asosiy so’z boyligi va oddiy iboralar bilan o‘yin, qo‘shiqlar va faoliyatlar orqali ishlashga e’tibor qaratiladi. Ingliz tilidagi dastlabki tajribalar kelajakdagi til o‘rganish uchun poydevor yaratishda muhim bo‘lib, asosiy muloqot ko‘nikmalarini rivojlantiradi.",
            video:
              "https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0",
            forWhom: [
              "Ingliz tilini o‘rganishni boshlagan 7-12 yoshdagi bolalar.",
              "Farzandlari uchun yuqori sifatli ingliz tili ta’limini qidirayotgan ota-onalar.",
              "Interaktiv va o‘yin-kulgi o‘quv muhitlarini yaxshi ko‘radigan yosh o‘rganuvchilar.",
            ],
            cost: "450.000 so‘m",
            ...
            effects: [
              "Yaxshilangan Muloqot Ko‘nikmalari",
              "Yaxshilangan Akademik Natijalar",
              "Oshirilgan Ishonch",
              "Uzoq Muddatli Foydalar",
            ],
            lengthOfClasses: "1 soat",
            frequency: "Haftada 2 marta",
            materials: "ta‘minlanadi",
            group: "6 kishigacha",
            ageLimit: "7 - 12",
          },
          {
            ...
            description:
              "Ushbu ixtisoslashtirilgan kurslar korporativ muhitdagi mutaxassislarning til ehtiyojlarini qondiradi. O‘quv dasturi biznes aloqalari, jumladan hisobotlar yozish, yig‘ilishlar o‘tkazish va professional munozaralarda ishtirok etishga qaratilgan.",
            video:
              "https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0",
            forWhom: [
              "Biznes ingliz tilini yaxshilashni istagan korporativ jamoalar va shaxslar.",
              "Xalqaro biznes uchun muloqot ko‘nikmalarini rivojlantirishga muhtoj mutaxassislar.",
              "Kompaniyalari uchun samarali biznes aloqalari bo‘yicha xodimlarini tayyorlamoqchi bo‘lgan kompaniyalar.",
            ],
            cost: "$ N/A",
            duration:
            ...
            effects: [
              "Biznes kontekstlarida samarali muloqot qilish qobiliyatining yaxshilanishi.",
              "Professional yozish va gapirish ko‘nikmalarining oshishi.",
              "Global biznes aloqalari uchun yaxshiroq tayyorgarlik.",
            ],
            lengthOfClasses: "1 soat 30 daqiqa",
            frequency: "Haftada 3 marta",
            materials: "ta‘minlanadi",
          ...
          },
          {
            ...
            video:
              "https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0",
            forWhom: [
              "Chet elda o‘qishni yoki ingliz tilida so‘zlashuvchi mamlakatlarga ko‘chib o‘tishni rejalashtirayotgan talabalar.",
              "Akademik yoki professional maqsadlar uchun IELTS, CEFR yoki TOEFL bo‘yicha yuqori ball olishi kerak bo‘lgan shaxslar.",
              "IELTS, CEFR yoki TOEFL imtihonlariga moslashtirilgan tayyorgarlik va amaliyotni qidirayotgan o‘rganuvchilar.",
              "Xalqaro standartlar asosida ingliz tili bilimlarini baholash yoki yaxshilashni maqsad qilgan shaxslar.",
            ],
            cost: "700.000 so‘m",
            duration: "4 oy",
            intensity: 4 / 5,
            ...
            effects: [
              "IELTS, TOEFL bo‘yicha imtihon natijalarining yaxshilanishi va aniq CEFR darajasi bahosi.",
              "Akademik va umumiy ingliz tilida bilim darajasining oshishi.",
              "Turli formatlarda tilni qo‘llash va test olish strategiyalari bo‘yicha ishonchning oshishi.",
            ],
            lengthOfClasses: "2 soat",
            frequency: "Haftada 3 marta",
            materials: "ta‘minlanadi",
            group: "10 kishigacha",
          },
          {
            ...
            video:
              "https://player.vimeo.com/video/753901222?autoplay=1&title=0&byline=0&portrait=0",
            forWhom: [
              "Ingliz tilidagi ko‘nikmalarni tezda yaxshilashni istagan shaxslar.",
              "Yaqinlashib kelayotgan imtihonlar yoki ilg‘or til bilimlarini talab qiluvchi professional muammolarga tayyorgarlik ko‘rayotgan talabalar.",
              "O‘z tilini rivojlantirish uchun tezkor formatni afzal ko‘radigan o‘rganuvchilar.",
            ],
            cost: "1.000.000 so‘m",
            duration: "12 oy",
            intensity: 4 / 5,
            ...
            effects: [
              "Til Bilishida Muhim Yaxshilanish",
              "Oshirilgan Ishonch va Muloqot Ko‘nikmalari",
              "Samarali O‘rganish Tajribasi",
            ],
            lengthOfClasses: "1 soat 30 daqiqa",
            frequency: "Haftada 6 marta",
            materials: "ta‘minlanadi",
            group: "10 kishigacha",
          },
        ],
    ...
    classContainer: {
      ...
      purpose: "Kurs maqsadi",
      effects: "Ta’siri",
      lengthOfClassesTitle: "Darslarning davomiyligi",
      frequencyTitle: "Darslar chastotasi",
      materialsTitle: "Kitoblar va o‘quv materiallari",
      groupTitle: "Guruh hajmi",
  ...
  offers: {
    ...
    forYou: {
      title: "siz uchun",
      desc: "Kursni tanlang va biz bilan sarguzashtni boshlang!",
      btn: "Kursni tanlash",
    },
    forCompanies: {
  ...
  contactPage: {
    workInfo: {
      ...
      getInTouchMessage:
        "Sizdan xabar olishdan mamnun bo‘lamiz. Quyidagi shaklni to‘ldiring yoki bizning kontakt ma’lumotlarimizdan foydalaning.",
      contactInformation: "Aloqa Ma’lumotlari",
      workingHours: "Ish Vaqti",
      location: "Manzil",
      viewOntheMap: "Xaritada ko‘rish",
      followUs: "Bizni ijtimoiy tarmoqlarda kuzating",
      sendAMessage: "Xabar yuborish",
      visitUs: "Bizga tashrif buyuring",
      visitInfo:
        "Bizning ofis manzilimizga keling. Siz bilan shaxsan uchrashishdan doimo xursandmiz.",
  ...
  merch: {
    header: {
      ...
      description:
        "Akademik yutuqlaringiz va muvaffaqiyatlaringiz orqali eksklyuziv mahsulotlarni qo'lga kiriting. Bizning merch pulga sotilmaydi - u faqat sizning mehnatingiz va fidoyiligingiz bilan qo'lga kiritiladi!",
      ...
      details: [
        {
          ...
          title: "Ball to'plang",
          description:
            "Akademik muvaffaqiyat, davomat va LEVEL dasturlarida ishtirok etish orqali ball to'plang.",
        },
        {
          key: "meritBasedSystem",
          title: "Mukofot tizimi",
          description:
            "Mahsulotlarni pulga sotib olib bo'lmaydi - ularni faqat o'z mehnatingiz va fidoyiligingiz bilan qo'lga kiritishingiz mumkin.",
        },
        {
          key: "redeemRewards",
          title: "Mukofotlarni almashtiring",
          description:
            "Mehnat bilan topgan ballaringizni LEVEL eksklyuziv mahsulotlariga almashtiring va yutuqlaringizni namoyish eting.",
        },
      ],
    },
    pointCalculator: {
      ...
      description:
        "Akademik yutuqlaringiz va ishtirokingiz orqali qanday qilib ball to'plashni bilib oling.",
    ...
    redeem: {
      ...
      description:
        "Toplagan ballaringizni eksklyuziv mahsulotlarga almashtiring.",
      button: "Almashtirish",
      points: "ball",
      cap: "LEVEL Cap",
      tshirt: "LEVEL Futbolka",
      sweatshirt: "LEVEL Sviter",
      hoodie: "LEVEL Hoodi",
    },
    howToRedeem: {
      ...
      steps: [
        {
          ...
          description:
            'Ushbu sahifada Point Calculator ostidagi "Ballaringizni tekshiring" tugmasini bosing, so‘ng joriy ballaringizni ko‘rish uchun o‘ziga xos talabalik ID raqamingizni kiriting.',
        },
        {
          key: "step2",
          title: "Mahsulotlarni ko'rib chiqing",
          description:
            "Mavjud mahsulotlarni va ularning ball talablarini o'rganing.",
        },
        {
          key: "step3",
          title: "Mahsulotingizni tanlang",
          description:
            'Almashtirmoqchi bo\'lgan mahsulotni tanlang va "Almashtirish" tugmasini bosing.',
        },
        {
          key: "step4",
          title: "Almashtirishni tasdiqlang",
          description:
            "Tanlovingizni ko'rib chiqing va almashtirishni tasdiqlang.",
        },
        {
          key: "step5",
          title: "Mahsulotingizni oling",
          description:
            "Belgilangan tarqatish vaqtida LEVEL ta'lim markazidan mahsulotingizni olib keting.",
        },
      ],
    },
    whyChooseMerch: {
      ...
      description:
        "Bizning mahsulotlarimiz shunchaki kiyim emas - bu sizning yutuqlaringizning ramzi.",
      features: [
        {
          key: "qualityMaterials",
          title: "Yuqori sifatli materiallar",
          description:
            "Barcha LEVEL mahsulotlari qulaylik va mustahkamlik uchun premium materiallardan tayyorlangan.",
        },
        {
          key: "exclusiveDesigns",
          title: "Eksklyuziv dizaynlar",
          description:
            "Bizning dizaynlarimiz faqat LEVEL o'quvchilari uchun mo'ljallangan va boshqa joyda sotib olib bo'lmaydi.",
        },
        {
          key: "symbolOfAchievement",
          title: "Yutuq ramzi",
          description:
            "LEVEL mahsulotlarini kiyish sizning akademik yutuqlaringiz va sadoqatingizni namoyish etadi.",
        },
        {
          key: "community",
          title: "Hamjamiyat tomonidan e'tirof etilish",
          description:
            "Yuqori natijalarga erishgan LEVEL o'quvchilari hamjamiyatining bir qismi sifatida tan olinishingiz mumkin.",
        },
      ],
    },
    faq: {
      ...
      questions: [
        {
          ...
          answer:
            "Ballar akademik natijalar, davomat, LEVEL dasturlarida qatnashish va o'qituvchilaringiz tomonidan e'tirof etilgan boshqa yutuqlar orqali to'planadi.",
        },
        {
          question: "Mahsulotlarni pulga sotib olish mumkinmi?",
          answer:
            "Yo'q, LEVEL mahsulotlari faqat ballarni ishlatish orqali olinadi. Ularni pulga sotib olib bo'lmaydi.",
        },
        {
          question: "Yangi mahsulotlar qanchalik tez qo'shiladi?",
          answer:
            "Har semestrda mahsulot kolleksiyamizni yangilab boramiz. Yangiliklar haqida e'lonlarni kuzatib boring!",
        },
      ],
    },
    modals: {
      redemptionSuccess: {
        ...
        description:
          "Siz {item} uchun ballaringizni muvaffaqiyatli almashtirdingiz.", // No direct translation, translated based on context
        collectMessage: "{item} ni qabulxonadan olishingiz mumkin.", // No direct translation, translated based on context
        idMessage:
          "Iltimos, tekshirish uchun talaba guvohnomangizni olib keling.",
      ...
      pointsCheck: {
        ...
        notEnoughPoints:
          "Eng kam narxdagi mahsulotni almashtirish uchun sizga kamida {minPoints} ball kerak.",
        closeButton: "Yopish",
      },
    },
    errors: {
      fetchFailed:
        "Talaba ma'lumotlarini yuklash muvaffaqiyatsiz yakunlandi. Iltimos, keyinroq qayta urinib ko'ring.", // No direct translation, translated based on context
      studentIdNotFound:
        "Talaba ID topilmadi. Iltimos, qayta urinib ko'ring yoki qabulxonaga murojaat qiling.",
      serverError:
        "Serverga ulanishda xatolik yuz berdi. Iltimos, keyinroq qayta urinib ko'ring.",
    },
  },
