      ...
      <div className="homeBanner pt-32 pb-12 rounded-b-3xl px-3 lg:px-16">
        <div className=" reveal relative rounded-2xl overflow-hidden lg:h-[450px] grid grid-cols-12 bg-white mx-auto dark:bg-[#020817]">
          ...
          <div className=" text-gray-600 dark:text-gray-400 py-4 px-10 col-span-12 lg:col-span-5 xl:col-span-4">
            <h1 className=" text-xl sm:text-2xl reveal mt-1 mb-4 text-[#6cce40] font-extrabold">
              Find out how to exercise <br /> well in a group!
            </h1>
            <p className=" text-[13px] reveal xl:text-[14px] 2xl:text-[15px] ">
              In our clubs you benefit from the richest offer of group fitness
              classes in Poland.
            </p>
            ...
            <p className=" text-[13px] reveal xl:text-[14px] 2xl:text-[15px] ">
              The offer also includes world-famous Les Mills training and our
              own fitness classes, such as Anti-Stress or the extremely popular
            ...
            <div className="flex reveal flex-col md:flex-row gap-4 md:gap-x-4 mt-4  mb-5 lg:mb-0">
              <Button
                variant="secondary"
                className="radial_bg_red shadow-xl text-white px-10 font-semibold  rounded-full text-[11px] sm:text-sm"
              >
                Buy a pass
              </Button>
              <Link
