  ...
  return (
    <div className="h-full max-w-[1900px] max-w-sc mx-auto">
        ...
        <div className=" relative rounded-2xl overflow-hidden  md:h-[450px] grid grid-cols-12 bg-[#f1fbec] mx-auto">
          <div className=" text-black p-6 lg:py-12 max-w-md mx-auto col-span-12 md:col-span-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-x-4 mt-8">
              <Button
                variant="secondary"
                className="radial_bg_red shadow-xl text-white px-8 font-semibold  rounded-full text-[11px]"
              >
          ...
          <div className=" col-span-12 md:col-span-6 rounded-2xl overflow-hidden">
            <img
              src="/blog_header.webp"
              className=" object-cover 2xl:object-top  w-full h-full"
              alt=""
            />
          </div>
        </div>
      ...
      <div className="my-10 px-3 lg:px-16 mx-auto mb-20">
        <h2 className=" text-center reveal font-bold text-2xl">
        ...
        <Tabs defaultValue="meeting" className="">
          <div className=" flex justify-center items-center flex-wrap gap-5 sm:gap-20 my-12 mb-16">
            <TabsList className=" flex-col md:flex-row h-auto rounded-2xl w-full md:h-20 p-3">
              <TabsTrigger
                className=" rounded-2xl w-full py-3 tab-shadow data-[state=active]:shadow-2xl"
                value="meeting"
              >
                <img
                  src="/tabicon1.webp"
                  className="mr-2 bitmap-icon"
                  width={35}
                  height={35}
                  alt=""
                />
            ...
            <div className=" grid grid-cols-1 gap-5 md:grid-cols-2">
              <div className=" max-w-md mx-auto flex items-start reveal flex-col justify-center px-3 md:px-0">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-x-4 mt-8">
                  <Button
                    variant="secondary"
                    className="radial_bg_red shadow-xl text-white px-8 font-semibold  rounded-full text-[11px] 2xl:text-lg"
                  >
                    I buy a pass and recieve a package
                  </Button>
                </div>
              ...
              <div className=" reveal rounded-2xl overflow-hidden dark:bg-[#020817]">
                <iframe
                  width="100%"
                  height="315"
          ...
          <TabsContent value="plan">
            <div className="flex flex-col-reverse md:grid gap-5 md:grid-cols-2">
              <div className=" rounded-2xl reveal overflow-hidden">
          ...
          <TabsContent value="into">
            <div className=" grid grid-cols-1 gap-5 md:grid-cols-2">
              ...
              <div className="reveal rounded-2xl">
                <img
                  src="/blog-intro.png"
