  ...
  return (
    <footer className=" bg-[#0d1c07] dark:bg-[#0d270273] rounded-t-3xl">
      <div className="max-w-[1900px] mx-auto px-3 lg:px-12 py-10 text-white">
        ...
        <div className="reveal grid grid-cols-12 md:gap-20 text-sm text-gray-300 px-6 py-16 md:px-3">
          <div className=" col-span-full md:col-span-4 ">
            ...
            <div className=" leading-6 break-words">
              ...
              Commercial Division of the National Court Register, KRS:
              0000370919, NIP: 8361676510, BDO: 000558784. Share capital PLN
              2,958,292.00.{' '}
            </div>
          </div>
          <div className=" col-span-full md:col-span-4 mt-10 md:mt-0">
            <div>Personal Data Protection Inspector Kinga Bieniek-Zawadzka</div>
            <Link
              className=" text-white underline font-bold"
              href="mailto:iod@benefitsystems.pl"
            >
        ...
        <div className="reveal flex flex-col gap-5 md:flex-row justify-between items-center px-6 md:px-3">
          <div className=" text-sm text-gray-300">
            © Copyright 2024 Benefit Systems S.A.
          </div>
