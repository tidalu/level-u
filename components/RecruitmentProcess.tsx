...
export default function RecruitmentProcess({
  ...
  const [currentStep, setCurrentStep] = useState<RecruitmentStep | undefined>(
    data?.[0]
  );
            ...
            {data?.map((step, index) => (
              <Button
                ...
                className={cn(
                  ...
                  "!whitespace-normal", // override shadcn's nowrap
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  {/* Make sure the language is set for proper hyphenation */}
                  <span lang="ru" className="text-lg hyphens-auto break-words">
                    {step.stepTitle}
                  </span>
                </div>
              </Button>
