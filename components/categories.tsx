  ...
  return (
    <div>
      <div className="flex lg:grid lg:grid-cols-5 gap-9  mt-10 scrollMobile pt-10 lg:pt-0">
        <div className="">
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] dark:bg-[#020817]  w-[220px] lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg dark:shadow-slate-900">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[0].title}
            </li>
            {data.classPage.classList[0].list.map((item) => (
              <li className="mb-1" key={item.name}>
                <Link
                  href={`/classess/${item.name.toLowerCase()}`}
                  className="hover:underline uppercase text-[#3d4939] dark:text-gray-300 text-[11px] 2xl:text-[14px] font-extrabold "
                >
                  {item.name}
                  <ChevronRight
                    size={12}
        ...
        <div className="">
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[1].title}
            </li>
          ...
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg mt-9">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[2].title}
            </li>
        ...
        <div className="">
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[3].title}
            </li>
          ...
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg mt-9">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[4].title}
            </li>
        ...
        <div className="">
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[5].title}
            </li>
          ...
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg mt-9">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[6].title}
            </li>
          ...
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg mt-9">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[7].title}
            </li>
        ...
        <div className="">
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[8].title}
            </li>
          ...
          <ul className="reveal bg-white custom-shadow dark:bg-[#86868517] w-[220px] dark:bg-[#020817]  lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg mt-9">
            <li className=" text-gray-400 font-semibold mb-3">
              {data.classPage.classList[9].title}
            </li>
