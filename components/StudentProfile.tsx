    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
        ...
        <div className="flex-1 text-center sm:text-left mt-2 sm:mt-0">
          <h3 className="text-lg sm:text-xl font-bold">{studentData["full Name"]}</h3>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
        <div className="bg-gray-50 rounded-lg p-2 sm:p-3 text-center">
          <div className="text-xl sm:text-2xl font-bold text-[#26913d]">{studentData.points}</div>
          <div className="text-xs text-gray-500 mt-1">Total Points</div>
        </div>
        <div className="bg-gray-50 rounded-lg p-2 sm:p-3 text-center">
          <div className="text-xl sm:text-2xl font-bold text-[#26913d]">{courses.length}</div>
        ...
        <div className="bg-gray-50 rounded-lg p-2 sm:p-3 text-center">
          <div className="text-xl sm:text-2xl font-bold text-[#26913d]">{studentData.redemed}</div>
