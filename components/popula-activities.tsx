            ...
            <ScrollAnimateWrapper>
              ...
              >
                ...
                <p className=" text-gray-600 dark:text-gray-400 text-[12px] 2xl:text-[13px] leading-6">
                  This is a series of intensive exercises that strengthen
                  muscles but do not cause them to grow too much. What is
                  functional training? During classes, exercises are performed
                  that imitate everyday activities (such as reaching for
                  something, getting out of bed, climbing stairs, walking,
                  etc.), but at a faster pace and often with additional weight
                  in the form of dumbbells or kettlebells. The effects of
                  functional training are primarily a general improvement in
                  efficiency, a slimmer figure (training is great for burning
                  fat tissue), improved circulation, and greater endurance. It
                  also strengthens joints and tendons. Recommended for people
            ...
            <ScrollAnimateWrapper>
              ...
              >
                ...
                <p className=" text-gray-600 dark:text-gray-400 text-[12px] 2xl:text-[13px] leading-6">
                  ...
                  flat stomach and a beautifully defined six pack - these
                  classes are for you! You will burn fat tissue, lose your
                  belly, sides and unnecessary kilograms and naturally improve
                  your fitness. A shaped figure and better well-being
                  guaranteed!
                </p>
          ...
          <div className=" rounded-2xl bg-[#b8df4b1a] dark:bg-[#86868517] group/item min-w-[300px] lg:min-w-fit relative">
            <ScrollAnimateWrapper>
              ...
              >
                ...
                <p className=" text-gray-600 dark:text-gray-400 text-[12px] 2xl:text-[13px] leading-6">
                  Yoga classes are mainly aimed at people who want to take care
                  of their body and mind in a calmer way. Exercises aimed at
                  ...
                  practicing yoga give you? It strengthens and tones the
                  muscles, helps to sculpt the figure, and relaxes. Therefore,
                  yoga can be practiced by both beginners and people who already
                  exercise regularly.
                </p>
