  ...
  return (
    <section>
      <div className="my-16 px-3 lg:px-16 mx-auto">
        <h2 className=" text-black reveal dark:text-white font-extrabold text-2xl text-center">
          Offer
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10 reveal">
            ...
            <div className="grid  grid-cols-1 sm:grid-cols-2">
              <div className="pl-10 py-10 md:py-5 flex flex-col justify-center text-sm 2xl:text-xl">
                ...
                <p className=" text-[12px] 2xl:text-lg leading-7 text-gray-500 ">
                  Choose a club, buy a pass and enjoy training!
                </p>
          ...
          <div className="rounded-2xl bg-[#e7e9e7] reveal">
            <div className="grid grid-cols-1 sm:grid-cols-2">
              <div className="pl-10 py-10 md:py-5 flex flex-col justify-center text-sm 2xl:text-xl">
                <div className=" text-black font-bold mb-5">for companies</div>
                <p className=" text-[12px] 2xl:text-lg leading-7 text-gray-500 ">
                  Check out our offer of <br />
                  employee and business passes!
                </p>

                <Button
                  variant="primaryGreen"
                  className="mt-6 dark:text-black shadow-xl w-fit rounded-full text-sm 2xl:text-lg"
                >
                  Find out more
                </Button>
              </div>
        ...
        <div className="flex gap-5 mt-5 scrollMobile ">
          <div className="reveal shadow-xl relative rounded-xl pt-32 md:pt-4 p-4 min-w-64 md:min-w-fit md:pl-32 flex-1 md:h-32 overflow-hidden dark:bg-[#0f1227]">
            <Link href="/blogs/package-info">
              ...
              <div className=" text-black dark:text-white relative z-10 mt-12 text-sm  mb-2">
                YES2<span className=" font-bold">MOVE</span>
              </div>
          ...
          <div className="group/item reveal shadow-xl relative rounded-xl pt-32 md:pt-4 p-4 min-w-64 md:min-w-fit md:pl-32 flex-1 md:h-32 overflow-hidden dark:bg-[#0f1227]">
            <Link href="/blogs/package-info">
